...
public class EmployeeEndpoint {
	...
	@RequestMapping(value=""
			  ...
			  , consumes="application/json"
			  , produces="application/json")
	public @Base64EncodeResponseBody ResponseEntity<ServiceResponse<List<EmployeeDTO> > > getAllEmployee(HttpServletRequest req) throws Throwable {
	...
	@RequestMapping(value="/{uuid}"
			  ...
			  , consumes="application/json"
			  , produces="application/json")
	public @Base64EncodeResponseBody ResponseEntity<ServiceResponse<EmployeeDTO> > getByUuid(HttpServletRequest req
	...
	@RequestMapping(value="/reqstr"
			  ...
			  , consumes="application/json"
			  , produces="application/json")
	public @Base64EncodeResponseBody ResponseEntity<String> encodeJson(HttpServletRequest req
	...
	@RequestMapping(value="/template"
			  ...
			  , consumes="application/json"
			  , produces="application/json")
	public ResponseEntity<String> getTemplate(HttpServletRequest req) throws Exception {	
		ServiceResponse<EmployeeDTO> response = new ServiceResponse<EmployeeDTO>();
		response.setTranRefNo(StringUtil.generateUUID() );
